const name = "CanvasCapture"; // Placed into the Mux and Write Application Name fields of the WebM header
const quality = 0.7; // good quality 1 Best < 0.7 ok to poor
const fps = 30; // I have tried all sorts of frame rates and all seem to work
...
const Groover = (function () {
  ...
  const dataTypes = {
    ...
    double2Str: function (num) {
      const c = new Uint8Array((new Float64Array([num])).buffer);
